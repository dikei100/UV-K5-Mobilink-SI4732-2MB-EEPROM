...
static void SI47XX_ReadBuffer(uint8_t *buf, uint8_t size) {
  I2C_Start();
...
static void SI47XX_WriteBuffer(uint8_t *buf, uint8_t size) {
  I2C_Start();
...
void SI47XX_PowerUp(void) {
  ...
  SYSTICK_DelayUs(63); // ~250ns * 250 = 62.5us
  waitToSend();
